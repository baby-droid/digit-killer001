...
export default function DashboardPage() {
  ...
  // Track for recent tick bubbles (fake live stream from API updates)
  ...
  return (
    <div className="space-y-4 animate-fade-in-up" data-testid="page-dashboard">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="cyber-card p-4 col-span-2">
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col items-end gap-1">
              <div className="text-xs text-muted-foreground font-rajdhani tracking-widest">
                CURRENT DIGIT
              </div>
              <div
                key={flipKey}
                ...
                style={{
                  ...
                  textShadow: `0 0 20px ${DIGIT_COLORS[currentDigit]}90`,
                }}
        ...
        <div className="cyber-card p-4 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-3 mt-2">
            <div>
              <span className="badge-even rounded px-2 py-0.5 text-xs font-bold font-rajdhani">
                E {evenPct}%
              </span>
            </div>
            <div>
              <span className="badge-odd rounded px-2 py-0.5 text-xs font-bold font-rajdhani">
                O {oddPct}%
              </span>
            </div>
          </div>
          ...
          {Array.from({ length: 10 }, (_, i) => i).map((d) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-rajdhani text-xs font-semibold" style={{ color }}>
                  {pct}%
                </div>
                <div className="font-rajdhani text-[10px] text-muted-foreground">{count}</div>
                {isHighest && (
                  <span className="text-[9px] font-bold text-green-400 font-rajdhani tracking-wider">HIGH</span>
                )}
                {isLowest && (
                  <span className="text-[9px] font-bold text-red-400 font-rajdhani tracking-wider">LOW</span>
                )}
              </div>
            );
          })}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="cyber-card p-4">
          <div className="font-rajdhani text-xs tracking-widest uppercase text-muted-foreground mb-2">
            Hottest Digit
          </div>
          <div
            className="font-orbitron text-3xl font-black"
            style={{
              color: DIGIT_COLORS[mostFreq],
              textShadow: `0 0 20px ${DIGIT_COLORS[mostFreq]}80`,
            }}
        ...
        <div className="cyber-card p-4">
          ...
          <div
            className="font-orbitron text-3xl font-black"
            style={{
              color: DIGIT_COLORS[leastFreq],
              textShadow: `0 0 20px ${DIGIT_COLORS[leastFreq]}80`,
            }}
