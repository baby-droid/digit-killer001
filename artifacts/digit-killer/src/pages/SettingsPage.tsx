...
const PAGE_TESTS = [
  ...
  { name: "Tick Analyser (R_50)",   path: "/api/tick-analysis?symbol=R_50",                          icon: BarChart2,   page: "Tick Analyser" },
  { name: "Rise/Fall (R_50)",       path: "/api/rise-fall-signals?symbol=R_50",                      icon: TrendingUp,  page: "Rise/Fall" },
...
type Tab = "health" | "troubleshoot" | "diagnostics" | "policy" | "users" | "pin";
